 ...
 */
static inline ret_code_t ultrawidelock_usbd_ret(int rc)
{
...
{
	return ultrawidelock_usbd_ret(nrfx_usbd_init(event_handler));
}

static inline ret_code_t nrf_drv_usbd_ep_transfer(nrfx_usbd_ep_t ep,
						  nrfx_usbd_transfer_t const *p_transfer)
{
	return ultrawidelock_usbd_ret(nrfx_usbd_ep_transfer(ep, p_transfer));
}

static inline ret_code_t
nrf_drv_usbd_ep_handled_transfer(nrfx_usbd_ep_t ep, nrfx_usbd_handler_desc_t const *p_handler)
{
	return ultrawidelock_usbd_ret(nrfx_usbd_ep_handled_transfer(ep, p_handler));
}
