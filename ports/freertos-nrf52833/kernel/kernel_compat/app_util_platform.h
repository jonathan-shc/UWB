 ...
 * unmodified.
 */
#ifndef WOZ_FREERTOS_KERNEL_COMPAT_APP_UTIL_PLATFORM_H
#define WOZ_FREERTOS_KERNEL_COMPAT_APP_UTIL_PLATFORM_H

#include "app_util.h"

#endif /* WOZ_FREERTOS_KERNEL_COMPAT_APP_UTIL_PLATFORM_H */
