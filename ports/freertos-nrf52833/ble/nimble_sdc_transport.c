...
/*
 * Measured on hardware 2026-08-14: 264 B peak across a full Aliro session
 * plus Matter traffic. The pump only moves HCI messages into the host's
 * mbufs; 1024 is 3.9x that peak.
 */
#ifndef WOZ_FREERTOS_NIMBLE_SDC_STACK_BYTES
#define WOZ_FREERTOS_NIMBLE_SDC_STACK_BYTES 1024u
#endif
