 ...
 * in the port's own include directory rather than here.
 */
#ifndef ULTRAWIDELOCK_HCI_COMPAT_UTIL_H
#define ULTRAWIDELOCK_HCI_COMPAT_UTIL_H

#include <ultrawidelock_freertos_vendor_macros.h>

#endif /* ULTRAWIDELOCK_HCI_COMPAT_UTIL_H */
