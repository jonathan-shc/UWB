 ...
 */
#ifndef ULTRAWIDELOCK_HCI_COMPAT_DRIVERS_BLUETOOTH_H
#define ULTRAWIDELOCK_HCI_COMPAT_DRIVERS_BLUETOOTH_H
...
#endif /* ULTRAWIDELOCK_HCI_COMPAT_DRIVERS_BLUETOOTH_H */
