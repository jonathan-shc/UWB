 ...
 */
#ifndef WOZ_FREERTOS_OT_KERNEL_H
#define WOZ_FREERTOS_OT_KERNEL_H
...
#include <woz_freertos_vendor_macros.h>
...
#define WOZ_OT_ATOMIC_BITS (sizeof(atomic_t) * 8u)
#define ATOMIC_DEFINE(name, nbits)                                                                 \
	atomic_t name[((nbits) + WOZ_OT_ATOMIC_BITS - 1u) / WOZ_OT_ATOMIC_BITS]
...
#endif /* WOZ_FREERTOS_OT_KERNEL_H */
