 ...
 */
#ifndef ULTRAWIDELOCK_FREERTOS_UWB_H
#define ULTRAWIDELOCK_FREERTOS_UWB_H
...
/* True once ultrawidelock_freertos_uwb_start() has succeeded. For status output that
...
#endif /* ULTRAWIDELOCK_FREERTOS_UWB_H */
