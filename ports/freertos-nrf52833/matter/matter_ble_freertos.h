 ...
 *
 * Everything here is port-side glue. The protocol lives in modules/woz_matter,
 ...
 *
 * Call before woz_freertos_nimble_host_start(): this adds a host hook, and the
 ...
 * reader has nothing to advertise as an Aliro reader either. Flags 3 + Matter 12
 * + Aliro 26 is 41 bytes in a 31-byte legacy packet, so it is one or the other
 * regardless.
 *
