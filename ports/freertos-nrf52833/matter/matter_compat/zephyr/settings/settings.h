 ...
 */
#ifndef ULTRAWIDELOCK_MATTER_COMPAT_ZEPHYR_SETTINGS_H
#define ULTRAWIDELOCK_MATTER_COMPAT_ZEPHYR_SETTINGS_H

#include "matter_settings_freertos.h"

#endif /* ULTRAWIDELOCK_MATTER_COMPAT_ZEPHYR_SETTINGS_H */
