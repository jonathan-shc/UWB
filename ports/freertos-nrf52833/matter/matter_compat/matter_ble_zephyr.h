 ...
 */
#ifndef ULTRAWIDELOCK_MATTER_COMPAT_MATTER_BLE_ZEPHYR_H
#define ULTRAWIDELOCK_MATTER_COMPAT_MATTER_BLE_ZEPHYR_H

#include "matter_ble_freertos.h"

#endif /* ULTRAWIDELOCK_MATTER_COMPAT_MATTER_BLE_ZEPHYR_H */
