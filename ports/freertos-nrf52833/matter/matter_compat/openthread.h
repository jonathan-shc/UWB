 ...
 */
#ifndef WOZ_MATTER_COMPAT_OPENTHREAD_H
#define WOZ_MATTER_COMPAT_OPENTHREAD_H
...
{
	return woz_freertos_openthread_instance();
}
...
{
	otInstance *ot = woz_freertos_openthread_instance();
	otError err;
...
#endif /* WOZ_MATTER_COMPAT_OPENTHREAD_H */
