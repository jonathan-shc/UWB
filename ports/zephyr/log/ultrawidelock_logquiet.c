 ...
 * @return 0 on success.
 */
static int ultrawidelock_logquiet_init(void)
{
...
/* After logging backends are up (APPLICATION), same phase as ultrawidelock_logfmt_init. */
SYS_INIT(ultrawidelock_logquiet_init, APPLICATION, CONFIG_APPLICATION_INIT_PRIORITY);
