...
**244 subsystems in 40 directories · 1483/1895 symbols documented (78%)**
...
| [`ports/dwm3001cdk/app/src/`](architecture/ports.dwm3001cdk.app.src/README.md) | 3 | 6/33 (18%) |
...
*Mined from git history as of `399a3ec`.*
