...
**299 subsystems in 42 directories · 1676/2340 symbols documented (71%)**
...
| [`scripts/`](architecture/scripts/README.md) | 23 | 87/116 (75%) |
...
*Mined from git history as of `ec4258a`.*
