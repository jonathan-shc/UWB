...
**310 subsystems in 45 directories · 2269/2450 symbols documented (92%)**
...
| [`scripts/`](architecture/scripts/README.md) | 26 | 135/148 (91%) |
...
*Mined from git history as of `a24ac3f`.*
