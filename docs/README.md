...
**316 subsystems in 46 directories · 2271/2453 symbols documented (92%)**
...
| [`scripts/`](architecture/scripts/README.md) | 31 | 137/151 (90%) |
...
*Mined from git history as of `541002b`.*
