...
**316 subsystems in 46 directories · 2270/2451 symbols documented (92%)**
...
| [`scripts/`](architecture/scripts/README.md) | 31 | 136/149 (91%) |
...
*Mined from git history as of `8289f7a`.*
