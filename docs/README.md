...
**241 subsystems in 39 directories · 1476/1861 symbols documented (79%)**
...
| [`modules/woz_aliro/src/`](architecture/modules.woz_aliro.src/README.md) | 21 | 215/253 (84%) |
...
*Mined from git history as of `a67c684`.*
