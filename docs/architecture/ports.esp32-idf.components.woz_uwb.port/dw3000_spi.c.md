...
# `ports/esp32-idf/components/woz_uwb/port/dw3000_spi.c`
...
**depends on** [`ports/esp32-idf/components/woz_uwb/port/board_pins.h`](board_pins.h.md)  ·  **discussed in** [`docs/porting.md`](../../porting.md), [`ports/esp32-idf/README.md`](../../../ports/esp32-idf/README.md), [`ports/esp32-idf/components/woz_uwb/README.md`](../../../ports/esp32-idf/components/woz_uwb/README.md)

## API

### `int dw3000_spi_init(void)`
`ports/esp32-idf/components/woz_uwb/port/dw3000_spi.c:42`
...
`ports/esp32-idf/components/woz_uwb/port/dw3000_spi.c:121`
...
`ports/esp32-idf/components/woz_uwb/port/dw3000_spi.c:173`
...
`ports/esp32-idf/components/woz_uwb/port/dw3000_spi.c:183`
...
`ports/esp32-idf/components/woz_uwb/port/dw3000_spi.c:193`
...
`ports/esp32-idf/components/woz_uwb/port/dw3000_spi.c:204`
...
`ports/esp32-idf/components/woz_uwb/port/dw3000_spi.c:213`
