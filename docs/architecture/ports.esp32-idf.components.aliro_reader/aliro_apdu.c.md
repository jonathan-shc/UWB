...
# `ports/esp32-idf/components/aliro_reader/aliro_apdu.c`
...
**depends on** [`ports/esp32-idf/components/aliro_reader/aliro_apdu.h`](aliro_apdu.h.md)  ·  **discussed in** [`ports/esp32-idf/components/aliro_reader/README.md`](../../../ports/esp32-idf/components/aliro_reader/README.md)
...
`ports/esp32-idf/components/aliro_reader/aliro_apdu.c:23`
...
`ports/esp32-idf/components/aliro_reader/aliro_apdu.c:33`
...
`ports/esp32-idf/components/aliro_reader/aliro_apdu.c:44`
...
`ports/esp32-idf/components/aliro_reader/aliro_apdu.c:59`
...
`ports/esp32-idf/components/aliro_reader/aliro_apdu.c:69`
...
`ports/esp32-idf/components/aliro_reader/aliro_apdu.c:75`
...
`ports/esp32-idf/components/aliro_reader/aliro_apdu.c:82`
...
`ports/esp32-idf/components/aliro_reader/aliro_apdu.c:88`
...
`ports/esp32-idf/components/aliro_reader/aliro_apdu.c:100`
...
`ports/esp32-idf/components/aliro_reader/aliro_apdu.c:138`
...
`ports/esp32-idf/components/aliro_reader/aliro_apdu.c:154`
...
`ports/esp32-idf/components/aliro_reader/aliro_apdu.c:178`
...
`ports/esp32-idf/components/aliro_reader/aliro_apdu.c:194`
...
`ports/esp32-idf/components/aliro_reader/aliro_apdu.c:213`
...
### `void aliro_tlv_w_init(struct aliro_tlv_w *w, uint8_t *buf, size_t cap)`
`ports/esp32-idf/components/aliro_reader/aliro_apdu.c:217`

Initializes a TLV writer to append into buf, with capacity cap and no error latched.
Must be called before any aliro_tlv_put / aliro_tlv_put_empty / w_byte calls on w.

### `int aliro_apdu_wrap(uint8_t ins, const uint8_t *tlv, size_t tlv_len, uint8_t *out, size_t cap, size_t *out_len)`
`ports/esp32-idf/components/aliro_reader/aliro_apdu.c:229`
...
`ports/esp32-idf/components/aliro_reader/aliro_apdu.c:252`
