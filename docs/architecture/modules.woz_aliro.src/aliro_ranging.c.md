...
```mermaid
flowchart TD
  aliro_ranging_feed --> lat_mark_seq
```
...
`modules/woz_aliro/src/aliro_ranging.c:126`
...
`modules/woz_aliro/src/aliro_ranging.c:160`
...
`modules/woz_aliro/src/aliro_ranging.c:233`
...
`modules/woz_aliro/src/aliro_ranging.c:322`
