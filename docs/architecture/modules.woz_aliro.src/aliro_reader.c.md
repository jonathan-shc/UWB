...
`modules/woz_aliro/src/aliro_reader.c:87`
...
`modules/woz_aliro/src/aliro_reader.c:186`
...
`modules/woz_aliro/src/aliro_reader.c:236`
...
`modules/woz_aliro/src/aliro_reader.c:249`
...
`modules/woz_aliro/src/aliro_reader.c:267`
...
**called by** `aliro_reader_authenticated_credential`, `aliro_reader_prov_print`, `aliro_reader_provision_add_trust`, `aliro_reader_provision_clear`, `aliro_reader_provision_identity`, `aliro_reader_stepup_arm`, `aliro_reader_stepup_status`, `aliro_reader_trust_clear`  ·  **calls** `compute_reader_group_x`

### `static int send_ap_command(uint16_t conn, uint8_t ins, const uint8_t *tlv, size_t len)`
`modules/woz_aliro/src/aliro_reader.c:294`
...
`modules/woz_aliro/src/aliro_reader.c:324`
...
`modules/woz_aliro/src/aliro_reader.c:358`
...
`modules/woz_aliro/src/aliro_reader.c:365`
...
`modules/woz_aliro/src/aliro_reader.c:418`
...
`modules/woz_aliro/src/aliro_reader.c:443`
...
`modules/woz_aliro/src/aliro_reader.c:473`
...
**called by** `on_auth0_response`  ·  **calls** `init_ble_channel`, `send_exchange`

### `static void on_auth0_response(struct aliro_session *s, const uint8_t *pl, size_t len)`
`modules/woz_aliro/src/aliro_reader.c:541`
...
`modules/woz_aliro/src/aliro_reader.c:622`
...
**called by** `transaction_feed`  ·  **calls** `init_ble_channel`, `send_exchange`

### `static void complete_ap_and_range(struct aliro_session *s)`
`modules/woz_aliro/src/aliro_reader.c:816`
...
**called by** `aliro_reader_rssi_sample`, `gated_complete_ap`  ·  **calls** `reader_status_send`

### `static void gated_complete_ap(struct aliro_session *s)`
`modules/woz_aliro/src/aliro_reader.c:873`
...
`modules/woz_aliro/src/aliro_reader.c:899`
...
`modules/woz_aliro/src/aliro_reader.c:926`
...
`modules/woz_aliro/src/aliro_reader.c:950`
...
`modules/woz_aliro/src/aliro_reader.c:1053`
...
**called by** `aliro_reader_rssi_sample`, `complete_ap_and_range`, `reader_status_send_on_host`

### `static void reader_status_send_on_host(bool unsecured)`
`modules/woz_aliro/src/aliro_reader.c:1081`
...
`modules/woz_aliro/src/aliro_reader.c:1120`
...
`modules/woz_aliro/src/aliro_reader.c:1127`
...
`modules/woz_aliro/src/aliro_reader.c:1140`
...
`modules/woz_aliro/src/aliro_reader.c:1160`
...
`modules/woz_aliro/src/aliro_reader.c:1178`
...
`modules/woz_aliro/src/aliro_reader.c:1279`
...
`modules/woz_aliro/src/aliro_reader.c:1332`
...
`modules/woz_aliro/src/aliro_reader.c:1347`
...
`modules/woz_aliro/src/aliro_reader.c:1396`
...
`modules/woz_aliro/src/aliro_reader.c:1430`
...
`modules/woz_aliro/src/aliro_reader.c:1456`
...
`modules/woz_aliro/src/aliro_reader.c:1474`
...
`modules/woz_aliro/src/aliro_reader.c:1492`
...
`modules/woz_aliro/src/aliro_reader.c:1509`
...
`modules/woz_aliro/src/aliro_reader.c:1546`
...
`modules/woz_aliro/src/aliro_reader.c:1577`
...
`modules/woz_aliro/src/aliro_reader.c:1621`
...
`modules/woz_aliro/src/aliro_reader.c:1664`
...
`modules/woz_aliro/src/aliro_reader.c:1691`
...
`modules/woz_aliro/src/aliro_reader.c:1745`
...
`modules/woz_aliro/src/aliro_reader.c:1778`
...
`modules/woz_aliro/src/aliro_reader.c:1812`
