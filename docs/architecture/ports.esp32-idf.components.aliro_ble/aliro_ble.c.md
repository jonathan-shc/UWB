...
`ports/esp32-idf/components/aliro_ble/aliro_ble.c:61`
...
`ports/esp32-idf/components/aliro_ble/aliro_ble.c:109`
...
`ports/esp32-idf/components/aliro_ble/aliro_ble.c:123`
...
`ports/esp32-idf/components/aliro_ble/aliro_ble.c:135`
...
`ports/esp32-idf/components/aliro_ble/aliro_ble.c:146`
...
`ports/esp32-idf/components/aliro_ble/aliro_ble.c:157`
...
`ports/esp32-idf/components/aliro_ble/aliro_ble.c:209`
...
`ports/esp32-idf/components/aliro_ble/aliro_ble.c:234`
...
`ports/esp32-idf/components/aliro_ble/aliro_ble.c:252`
...
`ports/esp32-idf/components/aliro_ble/aliro_ble.c:272`
...
`ports/esp32-idf/components/aliro_ble/aliro_ble.c:283`

WRITE: [version be16][featLen u8][features]. Validate + log the negotiated version.

### `struct ble_gatt_access_ctxt *ctxt, void *arg)`
`ports/esp32-idf/components/aliro_ble/aliro_ble.c:285`
