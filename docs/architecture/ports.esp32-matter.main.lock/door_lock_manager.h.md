...
# `ports/esp32-matter/main/lock/door_lock_manager.h`
...
**used by** [`ports/esp32-matter/main/app_main.cpp`](../ports.esp32-matter.main/app_main.cpp.md), [`ports/esp32-matter/main/app_shell.cpp`](../ports.esp32-matter.main/app_shell.cpp.md), [`ports/esp32-matter/main/lock/door_lock_callbacks.cpp`](door_lock_callbacks.cpp.md), [`ports/esp32-matter/main/lock/door_lock_manager.cpp`](door_lock_manager.cpp.md)

## API

### `struct WeekDaysScheduleInfo`
`ports/esp32-matter/main/lock/door_lock_manager.h:26`

Pairs a Matter week-day schedule entry with its DlScheduleStatus.

### `struct YearDayScheduleInfo`
`ports/esp32-matter/main/lock/door_lock_manager.h:32`

Pairs a Matter year-day schedule entry with its DlScheduleStatus.

### `struct HolidayScheduleInfo`
`ports/esp32-matter/main/lock/door_lock_manager.h:38`

Holds a Matter door lock holiday schedule entry paired with its DlScheduleStatus.

### `namespace LockInitParams`
`ports/esp32-matter/main/lock/door_lock_manager.h:59`
...
### `struct LockParam`
`ports/esp32-matter/main/lock/door_lock_manager.h:63`
...
`ports/esp32-matter/main/lock/door_lock_manager.h:100`

Returns the lock's current LockParam.

### `class BoltLockManager`
`ports/esp32-matter/main/lock/door_lock_manager.h:123`
