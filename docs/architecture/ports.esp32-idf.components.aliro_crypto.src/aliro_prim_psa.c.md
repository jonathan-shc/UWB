...
# `ports/esp32-idf/components/aliro_crypto/src/aliro_prim_psa.c`
...
**depends on** [`ports/esp32-idf/components/aliro_crypto/include/aliro_prim.h`](../ports.esp32-idf.components.aliro_crypto.include/aliro_prim.h.md)

## API

### `int aliro_prim_init(void)`
`ports/esp32-idf/components/aliro_crypto/src/aliro_prim_psa.c:26`
...
`ports/esp32-idf/components/aliro_crypto/src/aliro_prim_psa.c:33`
...
`ports/esp32-idf/components/aliro_crypto/src/aliro_prim_psa.c:42`
...
`ports/esp32-idf/components/aliro_crypto/src/aliro_prim_psa.c:78`
...
`ports/esp32-idf/components/aliro_crypto/src/aliro_prim_psa.c:114`
...
`ports/esp32-idf/components/aliro_crypto/src/aliro_prim_psa.c:142`
...
`ports/esp32-idf/components/aliro_crypto/src/aliro_prim_psa.c:168`
...
`ports/esp32-idf/components/aliro_crypto/src/aliro_prim_psa.c:195`
...
`ports/esp32-idf/components/aliro_crypto/src/aliro_prim_psa.c:222`
