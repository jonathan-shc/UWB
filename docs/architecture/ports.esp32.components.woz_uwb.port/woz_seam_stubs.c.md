...
**discussed in** [`ports/esp32/apps/reader/README.md`](../../../ports/esp32/apps/reader/README.md), [`ports/esp32/components/woz_uwb/README.md`](../../../ports/esp32/components/woz_uwb/README.md)

## API

### `int32_t woz_uwb_configure_phy(dwt_config_t *config)`
`ports/esp32/components/woz_uwb/port/woz_seam_stubs.c:29`

PHY configuration: nothing to log without uwb_rxdiag.c, so pass it straight on.

### `static void shim_rxok(const dwt_cb_data_t *d)`
`ports/esp32/components/woz_uwb/port/woz_seam_stubs.c:41`
