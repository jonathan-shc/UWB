...
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:34`
...
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:43`
...
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:49`
...
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:54`
...
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:75`
...
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:79`
...
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:99`
...
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:114`
...
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:122`
...
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:152`
...
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:174`
...
### `struct cherry_ccc_aliro_session_config *config`
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:177`

Borrowed pointer to the adapter's negotiated params, valid until destroy.

### `struct woz_uwb_aliro_cfg fcfg`
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:179`
...
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:244`
...
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:259`
...
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:305`
...
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:315`
...
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:325`
...
`modules/woz_uwb/src/ccc/cherry_ccc_shim.c:338`
