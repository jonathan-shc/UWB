...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:294`
...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:303`
...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:311`
...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:322`
...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:373`
...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:497`
...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:526`
...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:728`
...
**called by** `arm_final_sp3`, `arm_poll_sp3`, `ccc_pack_selftest`, `tx_response_sp3`, `woz_uwb_arm_rx`

### `static void sts_key_load(const uint8_t dursk[CCC_DURSK_LEN])`
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:812`
...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:862`

@brief One-shot: dump STS register lanes for the KAT V under three packings.

**called by** `woz_uwb_arm_rx`  ·  **calls** `pack_iv`, `pack_iv_rev`, `pack_key`

### `int32_t woz_uwb_arm_rx(int32_t mode)`
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:905`
...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:1028`
...
**called by** `arm_final_data_sp0`, `arm_final_sp3`, `arm_poll_sp3`, `prepoll_rx_rearm`, `revert_to_sp0_listen`

### `static int arm_poll_sp3(uint32_t prepoll_ip)`
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:1038`
...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:1095`
...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:1150`
...
**called by** `prepoll_rx_rearm`  ·  **calls** `gated_rxenable`

### `static int tx_response_sp3(uint32_t poll_ip, uint32_t resp_idx)`
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:1192`
...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:1231`
...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:1263`
...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:1314`
...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:1607`
...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:1656`
...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:1664`
...
`modules/woz_uwb/src/ccc/ccc_shim_rx.c:1706`
