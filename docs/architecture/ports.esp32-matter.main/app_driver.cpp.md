...
# `ports/esp32-matter/main/app_driver.cpp`
...
**depends on** [`ports/esp32-matter/main/app_priv.h`](app_priv.h.md), [`ports/esp32-matter/main/lock_led.h`](lock_led.h.md)
...
`ports/esp32-matter/main/app_driver.cpp:36`
...
`ports/esp32-matter/main/app_driver.cpp:47`
...
`ports/esp32-matter/main/app_driver.cpp:61`
...
`ports/esp32-matter/main/app_driver.cpp:90`
