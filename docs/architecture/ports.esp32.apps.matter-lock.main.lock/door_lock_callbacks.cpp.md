...
### `void door_lock_init()`
`ports/esp32/apps/matter-lock/main/lock/door_lock_callbacks.cpp:23`

Log that the door lock example has initialized. Performs no other setup.

### `void emberAfDoorLockClusterInitCallback(EndpointId endpoint)`
`ports/esp32/apps/matter-lock/main/lock/door_lock_callbacks.cpp:32`
...
`ports/esp32/apps/matter-lock/main/lock/door_lock_callbacks.cpp:47`
...
`ports/esp32/apps/matter-lock/main/lock/door_lock_callbacks.cpp:67`
...
`ports/esp32/apps/matter-lock/main/lock/door_lock_callbacks.cpp:84`
...
`ports/esp32/apps/matter-lock/main/lock/door_lock_callbacks.cpp:101`
