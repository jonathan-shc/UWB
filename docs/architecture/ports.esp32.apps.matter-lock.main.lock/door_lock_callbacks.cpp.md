...
# `ports/esp32/apps/matter-lock/main/lock/door_lock_callbacks.cpp`
...
### `void door_lock_init()`
`ports/esp32/apps/matter-lock/main/lock/door_lock_callbacks.cpp:22`

Log that the door lock example has initialized. Performs no other setup.

### `void emberAfDoorLockClusterInitCallback(EndpointId endpoint)`
`ports/esp32/apps/matter-lock/main/lock/door_lock_callbacks.cpp:31`
...
`ports/esp32/apps/matter-lock/main/lock/door_lock_callbacks.cpp:46`
...
`ports/esp32/apps/matter-lock/main/lock/door_lock_callbacks.cpp:66`
...
`ports/esp32/apps/matter-lock/main/lock/door_lock_callbacks.cpp:83`
...
`ports/esp32/apps/matter-lock/main/lock/door_lock_callbacks.cpp:98`
...
`ports/esp32/apps/matter-lock/main/lock/door_lock_callbacks.cpp:124`
...
`ports/esp32/apps/matter-lock/main/lock/door_lock_callbacks.cpp:133`
...
`ports/esp32/apps/matter-lock/main/lock/door_lock_callbacks.cpp:162`
...
`ports/esp32/apps/matter-lock/main/lock/door_lock_callbacks.cpp:188`
...
`ports/esp32/apps/matter-lock/main/lock/door_lock_callbacks.cpp:198`
