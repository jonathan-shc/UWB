...
/**
 * @file ultrawidelock_report.h — one range report, as a line of ASCII.
 *
 ...
 */
#ifndef ULTRAWIDELOCK_REPORT_H
#define ULTRAWIDELOCK_REPORT_H
...
#define ULTRAWIDELOCK_REPORT_LINE_MAX 128

/** Prefix every line starts with. Carries the version: see ultrawidelock_report_parse(). */
#define ULTRAWIDELOCK_REPORT_MAGIC "ARP1"

/** flags bits. */
#define ULTRAWIDELOCK_REPORT_F_VALID      0x01u /**< the distance is a real measurement */
#define ULTRAWIDELOCK_REPORT_F_CALIBRATED 0x02u /**< an antenna-delay constant was applied */
...
struct ultrawidelock_range_report {
	...
	uint8_t flags;      /**< ULTRAWIDELOCK_REPORT_F_* */
