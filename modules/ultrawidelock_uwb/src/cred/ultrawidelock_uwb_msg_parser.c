...
/**
 * @brief Extracts the protocol type from byte 0 of a credential message header.
...
/**
 * @brief Extracts the message type ID from byte 1 of a credential message header, used to dispatch
...
/**
 * @brief Extracts the payload length from bytes 2-3 of a credential message header as a 16-bit
 * big-endian integer.
 * @param bytes Pointer to the start of the raw message bytes.
