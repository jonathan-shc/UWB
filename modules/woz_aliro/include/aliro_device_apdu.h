...
#include "aliro_apdu.h" /* TLV writer/reader, tags, INS bytes, BLE envelope */
...
int aliro_dev_parse_exchange_cmd(const uint8_t *plain, size_t len,
				 struct aliro_exchange_command *c);
 ...
 *      the SW via aliro_apdu_append_sw) ---- */
