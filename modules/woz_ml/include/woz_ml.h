 ...
 * Generated by gen_model.py (tinyml repo); tests/host/test_woz_ml.c certifies
 * the C classifies identically to the trained model.
 *
 * FEED IT THE RIGHT NUMBERS. woz_ml_los_classify() takes raw features in
 * physical units, in enum woz_ml_los_feature order, and a wrong array cannot be
 * detected -- every float is legal. Do not fill it by hand: use
 * woz_ml_los_features() with the five CIA registers and the range.
 */
#ifndef WOZ_ML_H
#define WOZ_ML_H
