 ...
 */
/*
 * ultrawidelock_bytes.h - endian-neutral byte load/store helpers.
 *
 * Pure code: no OS, no allocation, no platform calls. It lives in ultrawidelock_port
 ...
 */
#ifndef ULTRAWIDELOCK_BYTES_H
#define ULTRAWIDELOCK_BYTES_H
