...
#define ULTRAWIDELOCK_PN532_APDU_WIRE_MAX     240
#define ULTRAWIDELOCK_PN532_ENVELOPE_DATA_MAX (ULTRAWIDELOCK_PN532_APDU_WIRE_MAX - 9)
...
#define ULTRAWIDELOCK_PN532_RESPONSE_DATA_MAX 240

enum ultrawidelock_pn532_apdu_mode {
	ULTRAWIDELOCK_PN532_APDU_PASSTHROUGH = 0,
	ULTRAWIDELOCK_PN532_APDU_ENVELOPE,
	ULTRAWIDELOCK_PN532_APDU_GET_RESPONSE,
};
 ...
 */
struct ultrawidelock_pn532_apdu_plan {
	const uint8_t *input;
	size_t input_length;
	size_t data_offset;
	size_t data_length;
	size_t emitted_data;
	uint32_t le;
	enum ultrawidelock_pn532_apdu_mode mode;
	bool extended;
	bool has_le;
	bool emitted;
	bool adapted;
