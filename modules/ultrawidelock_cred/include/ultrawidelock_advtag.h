 ...
 * (ultrawidelock_ble.c) calls this with the live expiry on every (re)advertise.
 */
#pragma once
#include <stdint.h>
...
#define ULTRAWIDELOCK_ADVTAG_LEN 7u
...
#define ULTRAWIDELOCK_ADVTAG_EXPIRY_UNAVAILABLE 0xFFFFFFFFu
