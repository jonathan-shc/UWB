 ...
 */
#ifndef WOZ_SLAM_HW_H
#define WOZ_SLAM_HW_H
 ...
 * Zephyr's lis2dh driver: see woz_slam.h for the measured reason. Verifies
 ...
 *         the resolution, by design, and woz_slam_poll()'s debounce is sized on
 *         that assumption.
 */
