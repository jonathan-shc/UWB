# ultrawidelock_roles.cmake — read one role manifest (modules/<mod>/roles/<role>.list)
...
# manifest path exists and every shared ultrawidelock_cred/ultrawidelock_uwb source is manifested.
#
...
#   ultrawidelock_role_sources("${REPO_ROOT}/modules/ultrawidelock_cred/roles/hash.list" HASH_SRCS)

function(ultrawidelock_role_sources listfile out_var)
