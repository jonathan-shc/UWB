...
Usage:
  ...
  scripts/aliro-enroll.py --node-id 0x1234 --pairing-code <11 digits> \
...
def main():
    ...
    if args.fresh_storage:
        ...
        EXTRA_ARGS.extend(["--storage-directory", tempfile.mkdtemp(prefix="aliro-enroll-")])
    ...
    header = (
        "/* GENERATED by scripts/aliro-enroll.py -- do not edit, do not commit.\n"
        " *\n"
