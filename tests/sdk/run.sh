...
check_declarations modules/woz_aliro/include/openaliro/reader.h
check_declarations modules/woz_aliro/include/openaliro/device.h
check_declarations modules/woz_aliro/include/openaliro/tlv.h
check_declarations modules/woz_uwb/include/openaliro/uwb.h
...
expected_headers=$(printf '%s\n' \
	...
	dw3000_spi.h openaliro.h reader.h tlv.h uwb.h woz_hal.h | LC_ALL=C sort)
installed_headers=$(find "$TMP/install/include/openaliro" -type f -name '*.h' \
