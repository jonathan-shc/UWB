 ...
 * them to the real responder through the injectable host radio (ultrawidelock_host_rx).
 ...
 */
#ifndef ULTRAWIDELOCK_HOST_TWIN_FRAMES_H
#define ULTRAWIDELOCK_HOST_TWIN_FRAMES_H
...
#endif /* ULTRAWIDELOCK_HOST_TWIN_FRAMES_H */
