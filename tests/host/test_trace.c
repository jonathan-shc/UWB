/**
 * @file test_trace.c — the [ULTRAWIDELOCK_TRACE] helpers
...
extern const char *trace_stub_hex8(char buf[ULTRAWIDELOCK_TRACE_HEX8_LEN], const uint8_t *bytes,
				   size_t len);
extern void trace_stub_emit(int v);

void test_trace(void)
{
	char buf[ULTRAWIDELOCK_TRACE_HEX8_LEN];
	...
	trace_stub_emit(42);
	T_OK("stub ULTRAWIDELOCK_TRACE no-op returns", 1);
}
