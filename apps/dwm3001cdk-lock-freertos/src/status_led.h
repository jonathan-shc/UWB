 ...
 */
#ifndef WOZ_FREERTOS_STATUS_LED_H
#define WOZ_FREERTOS_STATUS_LED_H
...
enum status_led_signal {
	/** The lock is open: an Aliro grant, or a Home tile tap. */
	STATUS_LED_UNLOCKED = (1u << 0),
	/** An Aliro secure session is established -- a phone is talking to us. */
...
#endif /* WOZ_FREERTOS_STATUS_LED_H */
