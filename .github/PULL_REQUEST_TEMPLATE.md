...
- [ ] No edits to fetched upstream (`workspace/`): changes go via
      `ports/nrf5340dk/{patches,overlays}/`, `firmware/` (the DWM3001CDK app),
      `modules/`, or `ports/`
...
<!-- If this affects on-air behavior: what was run on a DK + iPhone, and what was not.
